 ...
 *
 *=========================================================================*/
#ifndef itkHoughTransform3DLinesImageFilter_h
#define itkHoughTransform3DLinesImageFilter_h
...
{
/**
 * \class HoughTransform3DLinesImageFilter
 * \brief Performs the Hough Transform to find 3D straight lines
 *        in a 3D image.
 *
 ...
 *
 * \wiki
 * \wikiexample{Conversions/HoughTransform3DLinesImageFilter,HoughTransform3DLinesImageFilter}
 * \endwiki
 */
...
public:
  ...
  typedef HoughTransform3DLinesImageFilter Self;
  ...
  /** Line typedef */
  typedef LineSpatialObject< 3 >     LineType;
  ...
  itkTypeMacro(HoughTransform3DLinesImageFilter, ImageToImageFilter);
...
protected:
  ...
  virtual ~HoughTransform3DLinesImageFilter() {}

  void PrintSelf(std::ostream & os, Indent indent) const ITK_OVERRIDE;

  /** HoughTransform3DLinesImageFilter needs the entire input. Therefore
   * it must provide an implementation GenerateInputRequestedRegion().
   * \sa ProcessObject::GenerateInputRequestedRegion(). */
  void GenerateInputRequestedRegion() ITK_OVERRIDE;

  /** HoughTransform3DLinesImageFilter's output is the accumulator
  ...
  /** HoughTransform3DLinesImageFilter must produce the entire output */
  void EnlargeOutputRequestedRegion(DataObject *output) ITK_OVERRIDE;

private:

  HoughTransform3DLinesImageFilter(const Self &);
...
#include "itkHoughTransform3DLinesImageFilter.txx"
#endif
